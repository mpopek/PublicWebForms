<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pronajimani.aspx.cs" Inherits="PublicWebForms.forms.Pronajimani" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>PRONAJÍMÁNÍ ZVUKOVĚ OBRAZOVÝCH ZÁZNAMŮ / PROVOZOVÁNÍ VIDEO / DVD PŮJČOVEN
    </title>
    ...
    <div id="page">
        <asp:MultiView runat="server" ID="mvForm" ActiveViewIndex="0">
            <asp:View runat="server" ID="viewForm">
                <div class="header">
                    <h1>
                        PRONAJÍMÁNÍ ZVUKOVĚ OBRAZOVÝCH ZÁZNAMŮ / PROVOZOVÁNÍ VIDEO / DVD PŮJČOVEN</h1>
                </div>
                <div class="page">
                        ...
                        <tr>
                            <td colspan="2">
                                <p>
                                    ...
                                    <asp:HyperLink runat="server" ID="download" Target="_blank" Font-Bold="true" NavigateUrl="~/data/priloha_smlouvy_-_video-dvd_pujcovny.doc"> příloha >>></asp:HyperLink>
                                </p>
