<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PartnerstviVyrobenoSOsa.aspx.cs"
    Inherits="PublicWebForms.forms.PartnerstviVyrobenoSOsa" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>PARTNERSTVÍ OSA – ON-LINE ŽÁDOST (VYROBENO S OSA)</title>
            ...
            <asp:View runat="server" ID="viewForm">
                <div class="header">
                    <h1>
                        ...
                        <strong>VYROBENO S OSA</strong></h1>
                </div>
                <div class="page">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:OsaTextBox runat="server" ID="tbPSC" IsRequired="False" ValidationGroup="formZadost"
                                    ErrorMessage="Musíte zadat PSČ!" Width="80" CssClass="text psc" MaxLength="6" DataType="Int32"></asp:OsaTextBox>
                            </td>
                        </tr>
                        <tr>
                            <th>
                    ...
                    <table cellspacing="0">
                        <tr>
                            ...
                            <td class="noline" nowrap="nowrap">
                                <asp:OsaCheckBox runat="server" ID="cbUmisteniLogaNaWeb" Text="blíže specifikujte" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <asp:OsaTextBox runat="server" ID="tbUmisteniLogaNaWeb" IsRequired="False" ValidationGroup="formZadost"
                        ...
                        <tr>
                            <td class="noline">
                                <label>
                                    Umístění loga OSA na booklet, nebo do publikace jako speciální edice OSA</label>
                            </td>
                            <td class="noline" nowrap="nowrap">
                                <asp:OsaCheckBox runat="server" ID="cbUmisteniBooklet" Text="blíže specifikujte" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">
                                <asp:OsaTextBox runat="server" ID="tbUmisteniBooklet" IsRequired="False" ValidationGroup="formZadost"
                                    ErrorMessage="Musíte zadat specifikaci!" Width="460" CssClass="text" MaxLength="100"
                                    DataType="String"></asp:OsaTextBox>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="noline">
                                <label>
                                    Zmínění OSA jako generálního partnera v rámci rozhlasových nebo televizních spotů</label>
                            </td>
                            <td class="noline" nowrap="nowrap">
                                <asp:OsaCheckBox runat="server" ID="cbZmineniOSA" Text="blíže specifikujte" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">
                                <asp:OsaTextBox runat="server" ID="tbZmineniOSA" IsRequired="False" ValidationGroup="formZadost"
                                    ErrorMessage="Musíte zadat specifikaci!" Width="460" CssClass="text" MaxLength="100"
                                    DataType="String"></asp:OsaTextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="noline">
                                <label>
                                    Bezplatné poskytnutí produktů pro následnou propagaci OSA odpovídající 5% celkového
                                    nákladu</label>
                            </td>
                            <td class="noline" nowrap="nowrap">
                                <asp:OsaCheckBox runat="server" ID="cbBezplatnePoskytnuti" Text="blíže specifikujte" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">
                                <asp:OsaTextBox runat="server" ID="tbBezplatnePoskytnuti" IsRequired="False" ValidationGroup="formZadost"
                                    ErrorMessage="Musíte zadat specifikaci!" Width="460" CssClass="text" MaxLength="100"
                                    DataType="String"></asp:OsaTextBox>
                            </td>
                        </tr>
