...
{
    public partial class PartnerstviOsaTalent : System.Web.UI.Page
    {
        ...
        private string smlouvaTyp = "PARTNERSTVÍ OSA – ON-LINE ŽÁDOST (OSA TALENT)";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request["PDF"] == "regenerate" && ConfigurationManager.AppSettings["ActivateRegeneratePDF"] == "true")
            {
                using (dbDataContext db = new dbDataContext())
                {
                    ...
                    List<OSATBL_PWF_Zadost> list = (from a in db.OSATBL_PWF_PartnerstviOsaTalents
                    ...
                    if (list != null && list.Count() > 0)
                    {
                        ...
                        Response.Redirect(Page.ResolveClientUrl("~/forms/PartnerstviOsaTalent.aspx?PDF=regenerate"));
                    }
                }
            }
            if (Request["pdfid"] != null && Request["pdfid"].Length > 0 && ConfigurationManager.AppSettings["ActivateRegeneratePDF"] == "true")
            {
                using (dbDataContext db = new dbDataContext())
                {
                    OSATBL_PWF_PartnerstviOsaTalent smlouva = (from a in db.OSATBL_PWF_Zadosts
                                                               join b in db.OSATBL_PWF_PartnerstviOsaTalents on a.formGuid equals b.guid
                    ...
                    if (smlouva != null)
                    {
                        ...
                        tbOdhadovanyPocetNavstevniku2.Text = smlouva.odhadovanyPocetNavstevniku2;
                        tbKategorieVstupneho2.Text = smlouva.kategorieVstupneho2;
                        tbSponzoriAMedialni.Text = smlouva.sponzoriAMedialniSponzori2;
        ...
        {
            OSATBL_PWF_PartnerstviOsaTalent smlouva = new OSATBL_PWF_PartnerstviOsaTalent();
            ...
            smlouva.odhadovanyPocetNavstevniku2 = tbOdhadovanyPocetNavstevniku2.Text;
            smlouva.kategorieVstupneho2 = tbKategorieVstupneho2.Text;
            smlouva.sponzoriAMedialniSponzori2 = tbSponzoriAMedialni.Text;
            ...
            using (dbDataContext db = new dbDataContext())
            {
                try
                {
                    ...
                    db.OSATBL_PWF_PartnerstviOsaTalents.InsertOnSubmit(smlouva);
                    db.SubmitChanges();
            ...
            XDocument xml = new XDocument(
                ...
                new XElement("Zadost",
                    ...
                    new XElement("NabidkaPlneni",
                        ...
                        new XElement("OdhadovanzPocetNavstevniku", tbOdhadovanyPocetNavstevniku2.Text),
                        new XElement("KategorieVstupneho", tbKategorieVstupneho2.Text),
                        new XElement("SponzoriAMedialniPartneri", tbSponzoriAMedialni.Text)),
