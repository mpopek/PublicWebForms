<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZadostOPartnerstvi2.aspx.cs"
    Inherits="PublicWebForms.forms.ZadostOPartnerstvi" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>PARTNERSTVÍ OSA – ON-LINE ŽÁDOST</title>
                ...
                <div class="page">
                    ...
                    <table cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:OsaTextBox runat="server" ID="tbICRC" IsRequired="False" ValidationGroup="formZadost"
                                    ErrorMessage="Musíte zadat IČ nebo RČ!" Width="360" CssClass="text" MaxLength="15"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:OsaTextBox runat="server" ID="tbPSC" IsRequired="False" ValidationGroup="formZadost"
                                    ErrorMessage="Musíte zadat PSČ!" Width="80" CssClass="text" MaxLength="5" DataType="Int32"></asp:OsaTextBox>
                            </td>
                        </tr>
                        <tr>
                            <th>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:OsaTextBox runat="server" ID="tbTelefonKontakt" CssClass="text" Width="360"
