<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VydavaniNosicu.aspx.cs"
    Inherits="PublicWebForms.forms.VydavaniNosicu" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>VYDÁVÁNÍ ZVUKOVÝCH A HUDEBNÍCH ZVUKOVĚ OBRAZOVÝCH NOSIČŮ A MULTIMÉDIÍ</title>
    ...
    <div id="page">
        <asp:MultiView runat="server" ID="mvForm" ActiveViewIndex="0">
            <asp:View runat="server" ID="viewForm">
                <div class="header">
                    <h1>
                        VYDÁVÁNÍ ZVUKOVÝCH A HUDEBNÍCH ZVUKOVĚ OBRAZOVÝCH NOSIČŮ A MULTIMÉDIÍ</h1>
                </div>
                <div class="page">
                    ...
                    <table cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:OsaTextBox runat="server" ID="tbNosic1_naklad" CssClass="text numeric" Width="360"
                                    MaxLength="100" DataType="String" IsRequired="false" ValidationGroup="formLicencniSmlova"
                                    ErrorMessage="Musíte zadat náklad!"></asp:OsaTextBox>
                            </td>
                        </tr>
                        <tr>
                            <th>
                    ...
                    <table cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:OsaTextBox runat="server" ID="tbNosic2_naklad" CssClass="text numeric" Width="360"
                                    MaxLength="100" DataType="String" IsRequired="false" ValidationGroup="formLicencniSmlova"
                                    ErrorMessage="Musíte zadat náklad!"></asp:OsaTextBox>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <p>
                                    Součástí tohoto formuláře je soubor
                                    <asp:HyperLink runat="server" ID="download2" Target="_blank" Font-Bold="true" NavigateUrl="~/data/Audiovize_hudebni_sestava.pdf">oznámení o skladbách >>></asp:HyperLink>
                                </p>
                                <table class="file" cellspacing="0">
                                    <tr>
                                        <td>
