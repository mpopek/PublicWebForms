...
{
    public partial class VyrobaDovoz : System.Web.UI.Page
    {
        ...
        private string smlouvaTyp = "VÝROBA, DOVOZ A PŘIJÍMÁNÍ NENAHRANÝCH NOSIČŮ A PŘÍSTROJŮ K ROZMNOŽOVÁNÍ";
        ...
        {
            OSATBL_PWF_VyrobaDovoz smlouva = new OSATBL_PWF_VyrobaDovoz();
            ...
            using (dbDataContext db = new dbDataContext())
            {
                try
                {
                    ...
                    db.OSATBL_PWF_VyrobaDovozs.InsertOnSubmit(smlouva);
                    db.SubmitChanges();
