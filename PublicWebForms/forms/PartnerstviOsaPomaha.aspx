<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PartnerstviOsaPomaha.aspx.cs"
    Inherits="PublicWebForms.forms.PartnerstviOsaPomaha" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>PARTNERSTVÍ OSA – ON-LINE ŽÁDOST (OSA POMÁHÁ)</title>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:OsaTextBox runat="server" ID="tbPSC" IsRequired="False" ValidationGroup="formZadost"
                                    ErrorMessage="Musíte zadat PSČ!" Width="80" CssClass="text psc" MaxLength="6"
                                    DataType="Int32"></asp:OsaTextBox>
                            </td>
                        </tr>
                        <tr>
                            <th>
