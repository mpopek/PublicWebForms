<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PartnerstviOsaTalent.aspx.cs"
    Inherits="PublicWebForms.forms.PartnerstviOsaTalent" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>PARTNERSTVÍ OSA – ON-LINE ŽÁDOST (OSA TALENT)</title>
                            ...
                            <td colspan="3" class="nopadding">
                                <table>
                                    <tr>
                                        ...
                                        <td class="noline">
                                            <asp:OsaTextBox runat="server" ID="tbOdhadovanyPocetNavstevniku2" IsRequired="False"
                                                ValidationGroup="formZadost" ErrorMessage="Musíte zadat odhadovaný počet návštěvníků!"
                            ...
                            <td colspan="3" class="nopadding">
                                <table>
                                    <tr>
                                        ...
                                        <td class="noline">
                                            <asp:OsaTextBox runat="server" ID="tbKategorieVstupneho2" IsRequired="False" ValidationGroup="formZadost"
                                                ErrorMessage="Musíte zadat kategorii vstupného!" Width="360" CssClass="text"
                                                MaxLength="100" DataType="String"></asp:OsaTextBox>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <td colspan="3" class="nopadding">
                                <table>
                                    <tr>
                                        ...
                                        <td class="noline">
                                            <asp:OsaTextBox runat="server" ID="tbSponzoriAMedialni" IsRequired="False" ValidationGroup="formZadost"
                                                ErrorMessage="Musíte zadat sponzory a mediální partnery!" Width="360" Height="80"
                                                TextMode="MultiLine" CssClass="text" MaxLength="300" DataType="String"></asp:OsaTextBox>
                                        </td>
                                    </tr>
                                </table>
