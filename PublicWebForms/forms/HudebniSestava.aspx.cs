...
{
    public partial class HudebniSestava : System.Web.UI.Page
    {
        ...
        private bool SaveDataToDB()
        {
            ...
            OSATBL_PWF_HudebniSestava smlouva = new OSATBL_PWF_HudebniSestava();
            smlouva.guid = Guid.NewGuid().ToString();
            smlouva.createDate = smlouvaCreateDate;

            smlouva.vyrobce = Vyrobce.Text;
            smlouva.nazev = NazevNosice.Text;
            smlouva.reziser = Reziser.Text;
            smlouva.druhNosice = DruhNosice.Text;
            smlouva.celkovaStopazNosice = CelkovaStopaz.Text;

            OSATBL_PWF_HudebniSestava_Polozky p1 = new OSATBL_PWF_HudebniSestava_Polozky();
            OSATBL_PWF_HudebniSestava_Polozky p2 = new OSATBL_PWF_HudebniSestava_Polozky();
            OSATBL_PWF_HudebniSestava_Polozky p3 = new OSATBL_PWF_HudebniSestava_Polozky();
            ...
            p1.stopaz = MinutazSkladby1.Text;
            p2.stopaz = MinutazSkladby2.Text;
            p3.stopaz = MinutazSkladby3.Text;
            ...
            p1.autorUprav = AutorUprav1.Text;
            p2.autorUprav = AutorUprav2.Text;
            p3.autorUprav = AutorUprav3.Text;
            p1.interpret = Interpret1.Text;
            p2.interpret = Interpret2.Text;
            p3.interpret = Interpret3.Text;
            p1.nazevARok = NazevARok1.Text;
            p2.nazevARok = NazevARok2.Text;
            p3.nazevARok = NazevARok3.Text;
            ...
            using (dbDataContext db = new dbDataContext())
            {
                try
                {
                    ...
                    db.OSATBL_PWF_HudebniSestavas.InsertOnSubmit(smlouva);
                    db.SubmitChanges();
                    db.OSATBL_PWF_HudebniSestava_Polozkies.InsertOnSubmit(p1);
                    db.OSATBL_PWF_HudebniSestava_Polozkies.InsertOnSubmit(p2);
                    db.OSATBL_PWF_HudebniSestava_Polozkies.InsertOnSubmit(p3);
                    db.SubmitChanges();
