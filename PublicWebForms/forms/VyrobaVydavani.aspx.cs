...
{
    public partial class VyrobaVydavani : System.Web.UI.Page
    {
        ...
        private string smlouvaTyp = "VÝROBA AUDIOVIZUÁLNÍCH DĚL, VYDÁVÁNÍ FILMOVÝCH ZVUKOVĚ OBRAZOVÝCH NOSIČŮ A MULTIMEDIÍ";
        ...
        {
            OSATBL_PWF_VyrobaVydavani smlouva = new OSATBL_PWF_VyrobaVydavani();
            ...
            using (dbDataContext db = new dbDataContext())
            {
                try
                {
                    ...
                    db.OSATBL_PWF_VyrobaVydavanis.InsertOnSubmit(smlouva);
                    db.SubmitChanges();
