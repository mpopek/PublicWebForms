<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OznameniOSkladbach.aspx.cs"
    Inherits="PublicWebForms.forms.OznameniOSkladbach" %>
                ...
                <div class="page">
                    ...
                    <table cellspacing="0">
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:OsaTextBox runat="server" ID="Vydavatel" CssClass="text" Width="360" IsRequired="true"
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:OsaTextBox runat="server" ID="CisloNosice" CssClass="text numeric" Width="360"
                                    IsRequired="true" MaxLength="10" DataType="Int64" ValidationGroup="formZadost"></asp:OsaTextBox>
                            </td>
                        </tr>
                        <tr>
                            <th>
                        ...
                        <tr>
                            <th>
                                <label class="required">
                                    Celková minutáž:</label>
                            </th>
                            <td colspan="3">
                                <asp:OsaTextBox runat="server" ID="CelkovaMinutaz" CssClass="text" Width="360" IsRequired="true"
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:OsaTextBox runat="server" ID="Lisovna" CssClass="text" Width="360" IsRequired="true"
                                    MaxLength="100" DataType="String" ValidationGroup="formZadost"></asp:OsaTextBox>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:TextBox runat="server" ID="Zpracovatel1" CssClass="text" Width="360" MaxLength="100"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <th>
                    ...
                    <table cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:TextBox runat="server" ID="Zpracovatel2" CssClass="text" Width="360" MaxLength="100"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <th>
                    ...
                    <table cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:TextBox runat="server" ID="Zpracovatel3" CssClass="text" Width="360" MaxLength="100"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <th>
